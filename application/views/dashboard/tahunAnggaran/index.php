                                ...
                                <div class="table-responsive border rounded">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $result->nama_tahun_anggaran ?></td>
                                                        <td class="text-center"><?php echo 'Rp. ' . number_format($result->budget_tahun_anggaran, 0, ',', '.'); ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="flex align-items-center list-user-action">
                                                                <a href="<?php echo route('anggaran.ubah', ['uuid' => $result->uuid_tahun_anggaran]) ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                                ...
                                                                <a class="btn btn-sm btn-icon btn-danger rounded btn-delete-user" data-uuid="<?php echo $result->uuid_tahun_anggaran ?>" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Delete">
                                                                    <span class="btn-inner">
                                    ...
                                    <div class="d-flex justify-content-between mb-10 mr-10">
                                        ...
                                        <nav class="d-flex justify-content-end" aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item"><a class="page-link" id="previousPage" href="<?php echo route('anggaran.home2', ['offset' => $start != '' && $start > 1 ? $start - 1 : '']) ?>">Sebelumnya</a></li>
                                                <li class="page-item"><a class="page-link" id="currentPage" data-current="<?php echo $start != "" ? $start : 1; ?>" disabled><?php echo $start != "" ? $start : 1; ?></a></li>
                                                <li class="page-item"><a class="page-link" id="nextPage" href="<?php echo route('anggaran.home2', ['offset' => $start != '' && $start < $next ? $start + 1 : '']) ?>">Selanjutnya</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <?php echo form_open(route('anggaran.hapus')) ?>
