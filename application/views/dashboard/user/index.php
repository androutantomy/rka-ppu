        ...
        <div class="content-inner container-fluid pb-0" id="page_layout">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $result->nama_user ?></td>
                                                        <td class="text-center"><?php echo $result->email_user ?></td>
                                                        <td class="text-center"><?php echo $result->nama_level ?></td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="flex align-items-center list-user-action">
                                                                <a href="<?php echo route('user.ubah', ['uuid' => $result->uuid_user]) ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit">
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <?php echo form_open(route('user.hapus')) ?>
            ...
            <script>
                ...
                function search() {
                    ...
                    window.location = '<?php echo site_url("user/") ?>' + '1/' + searchValue.value;
                }
