...
<body >
   ...
   <div class="content-inner container-fluid pb-0 width1">
      <div class="row align-items-center align-self-center ">
        <a href="<?php echo route('pilih-tahun-anggaran') ?>" class="navbar-brand d-flex align-items-center mb-3 justify-content-center text-primary" style="padding-top:5%;">
        ...
        <h5 style="font-family:'Poppins';color:white;text-align:center;padding-bottom:40px;">Universitas 17 Agustus Samarinda</h5>
            <div class="col-lg-4 col-md-4 padding-tahun">
                ...
                <div class="card text-center" style="background: rgba(255,255,255,0.4);">
                    ...
                    <svg width="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="color: yellow;">
                        ...
                        <h5 style="padding-top:10px;color: yellow;">2023</h5>
            ...
            <div class="col-lg-4 col-md-4 padding-tahun">
                ...
                <div class="card text-center" style="background: rgba(255,255,255,0.4);">
                    ...
                    <svg width="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="color: yellow;">
                        ...
                        <h5 style="padding-top:10px;color: yellow;">2022</h5>
            ...
            <div class="col-lg-4 col-md-4 padding-tahun">
                ...
                <div class="card text-center" style="background: rgba(255,255,255,0.4);">
                    ...
                    <svg width="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="color: yellow;">
                        ...
                        <h5 style="padding-top:10px;color: yellow;">2021</h5>
