                                ...
                                <div class="table-responsive border rounded">
                                    ...
                                    <table id="user-list-table" class="table table-bordered" role="grid">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $result->is_utama != "" ? '<strong>' . $result->no_rekening_pendapatan . '</strong>' : ucwords(strtolower($result->no_rekening_pendapatan)) ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="flex align-items-center list-user-action">
                                                                <a href="<?php echo route('pendapatan.ubah', ['uuid' => $result->uuid_pendapatan]) ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                                ...
                                                                <a class="btn btn-sm btn-icon btn-danger rounded btn-delete-user" data-uuid="<?php echo $result->uuid_pendapatan ?>" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Delete">
                                                                    <span class="btn-inner">
                                    ...
                                    <div class="d-flex justify-content-between mb-10 mr-10">
                                        ...
                                        <nav class="d-flex justify-content-end" aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item"><a class="page-link" id="previousPage" href="<?php echo route('pendapatan.home2', ['start' => $prev, 'search' => $search]) ?>">Sebelumnya</a></li>
                                                <li class="page-item"><a class="page-link" id="currentPage" disabled><?php echo $start != "" ? $start : 1; ?></a></li>
                                                <li class="page-item"><a class="page-link" id="nextPage" href="<?php echo route('pendapatan.home2', ['start' => $next, 'search' => $search]) ?>">Selanjutnya</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <?php echo form_open(route('pendapatan.hapus')) ?>
