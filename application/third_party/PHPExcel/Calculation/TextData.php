...
class PHPExcel_Calculation_TextData
{
    ...
    private static function unicodeToOrd($c)
    {
        if (ord($c[0]) >=0 && ord($c[0]) <= 127) {
            ...
            return (ord($c[0])-240)*262144 + (ord($c[1])-128)*4096 + (ord($c[2])-128)*64 + (ord($c[2])-128);
        } elseif (ord($c[0]) >= 248 && ord($c[0]) <= 251) {
            return (ord($c[0])-248)*16777216 + (ord($c[1])-128)*262144 + (ord($c[2])-128)*4096 + (ord($c[2])-128)*64 + (ord($c[2])-128);
        } elseif (ord($c[0]) >= 252 && ord($c[0]) <= 253) {
            return (ord($c[0])-252)*1073741824 + (ord($c[1])-128)*16777216 + (ord($c[2])-128)*262144 + (ord($c[2])-128)*4096 + (ord($c[2])-128)*64 + (ord($c[2])-128);
