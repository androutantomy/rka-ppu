            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                <li class="nav-item">
                    <a href="<?php echo site_url('dashboard') ?>" class="navbar-brand">
                        <img src="<?php echo base_url() ?>assets/images/logo.png" style="width:50%;margin-top:-10px;text-align:center;">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'dashboard' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('dashboard.home') ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'anggaran' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('anggaran.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Tahun Anggaran" data-bs-placement="right">
                        ...
                        <span class="item-name">Tahun Anggaran</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'pendapatan' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('pendapatan.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Pendapatan" data-bs-placement="right">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'biaya' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('biaya.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Standar Biaya" data-bs-placement="right">
                            <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <span class="item-name">Standar Biaya</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'satuan' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('satuan.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Satuan" data-bs-placement="right">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'kegiatan' || $active == 'subkegiatan' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('kegiatan.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Kegiatan" data-bs-placement="right">
                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'aktifitas' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('aktifitas.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Log Aktifitas" data-bs-placement="right">
                        <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <span class="item-name">Log Aktifitas</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $active != '' && $active == 'belanja' ? 'active' : '' ?>" aria-current="page" href="<?php echo route('belanja.home') ?>">
                        <i class="icon" data-bs-toggle="tooltip" title="Rincian Belanja" data-bs-placement="right">
                            <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <span class="item-name">Rincian Belanja</span>
                    </a>
                </li>
                <!-- <li class="nav-item">
                    <a class="nav-link" href="<?php echo route('logout') ?>">
                        ...
                        <span class="item-name">Keluar</span>
                    </a>
                </li> -->
