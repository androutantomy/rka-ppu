                        ...
                        <div class="card-body">
                            <div class=" justify-content-between">
                                <div class="">
                                    ...
                                    <h5 class="mb-0 ms-2" style="float:right !important;color:green;font-weight: 400;">Anggaran 2023</h5>
                                </div>
                            </div>
                            <div class="">
                                <div>
                ...
                <div class="col-lg-8">
                    <div class="card card-block card-stretch card-height">
                        <div class="flex-wrap card-header d-flex justify-content-between border-0">
                            <div class="header-title">
                                <h4 class=" card-title">List Rincian Belanja</h4>
                            </div>
                            <div>
                                <a href="<?php echo route('belanja.home') ?>">
                                    <h6 style="color:#9B0D23;"><u>Lihat Selengkapnya</u></h6>
                                </a>
                            </div>
                        </div>
                                ...
                                <div class="table-responsive border rounded">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="border-bottom-width:0px !important;padding:10px !important;"><strong>Kegiatan Penyediaan dan Pemeliharaan Sarana & Prasarana</strong></td>
                                            ...
                                            <tr>
                                                <td style="border-bottom-width:0px !important;padding:10px !important;"><strong>Kegiatan Kepustakaan</strong>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">20 buah x 10 buah</td>
                                            ...
                                            <tr>
                                                <td>5.1.1.2.3.002 Batterai Alkaline Kotak 11 Volt</td>
                                                <td class="text-center">20 buah x 10 buah</td>
                                                <td class="text-center">5.000</td>
                                                <td class="text-center">11%</td>
                                                <td class="text-center">1.000.000</td>
