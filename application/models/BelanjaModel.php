...
class BelanjaModel extends CI_Model
{
    ...
    function get_all_data($filter)
    {
        ...
        $this->db->or_where('parent_kegiatan', '-');
        if ($filter['limit'] > 0) {
    ...
    {
        $this->db->select('c.nama_satuan, uuid_belanja, b.no_rekening_standar_biaya, b.jumlah_standar_biaya, b.nama_standar_biaya, tanggal_belanja, rincian_belanja.uuid_kegiatan, rincian_belanja.uuid_standar_biaya, koefisien_1, koefisien_2, volume_1, volume_2, pajak, total_belanja');
    ...
    {
        $this->db->select('a.uuid_belanja, a.tanggal_belanja, a.uuid_kegiatan, a.uuid_standar_biaya, a.koefisien_1, a.volume_1, a.pajak, a.keterangan, a.uuid_user, a.edited, a.total_belanja, b.nama_kegiatan, c.nama_standar_biaya, c.jumlah_standar_biaya, d.nama_satuan, e.nama_satuan as satuan_belanja');
