                        ...
                        <div class="card-body">
                            <div class=" justify-content-between">
                                <div class="">
                                    ...
                                    <h5 class="mb-0 ms-2" style="float:right !important;color:green;font-weight: 400;">Belanja Yayasan</h5>
                                </div>
                            </div>
                            <div class="">
                                <div>
                        ...
                        <div class="card-body">
                            <div class=" justify-content-between">
                                <div class="">
                                    ...
                                    <h5 class="mb-0 ms-2" style="float:right !important;color:green;font-weight: 400;">Belanja Prodi</h5>
                                </div>
                            </div>
                            <div class="">
                                <div>
                        ...
                        <div class="card-body">
                            <div class=" justify-content-between">
                                <div class="">
                                    ...
                                    <h5 class="mb-0 ms-2" style="float:right !important;color:#F16A1B;font-weight: 400;">Total Prodi</h5>
                                </div>
                            </div>
                            <div class="">
                                <div>
                        ...
                        <div class="card-body">
                            <div class=" justify-content-between">
                                <div class="">
                                    ...
                                    <h5 class="mb-0 ms-2" style="float:right !important;color:#F16A1B;font-weight: 400;">Rincian Belanja</h5>
                                </div>
                            </div>
                            <div class="">
                                <div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-lg-3">
                                        <label class="form-label" for="exampleFormControlSelect1">Prodi</label>
                                        <select class="form-select" id="exampleFormControlSelect1">
                                            <option selected="" disabled="">----- Pilih -----</option>
                                            <option>Admin Prodi 1</option>
                                            <option>Admin Prodi 2</option>
                                            <option>Admin Prodi 3</option>
                                        </select>
                                    </div>
                                    <div class="form-group col-lg-3">
        ...
        <div class="offcanvas offcanvas-end live-customizer" tabindex="-1" id="live-customizer" data-bs-backdrop="false" data-bs-scroll="true" aria-labelledby="live-customizer-label" aria-modal="true" role="dialog">
            <div class="offcanvas-header pb-0">
                <div class="d-flex align-items-center">
                    <h4 class="offcanvas-title" id="live-customizer-label">Rincian Belanja</h4>
                </div>
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="type" class="selectpicker form-control" data-style="py-0">
                                    <option>Kegiatan Penerimaan Mahasiswa Baru</option>
                                    <option>Kegiatan Kepustakaan</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
