                        ...
                        <form>
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" id="tahun" value="Krisnawan Adi" name="tahun">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="lname">Email</label>
                                 <input type="email" class="form-control" id="email" value="krisnawan455@gmail.com">
                              </div>
                              <div class="form-group col-md-6">
                        ...
                        <form>
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" id="tahun" value="krisnawan455@gmail.com" name="username">
                              </div>
                              <div class="form-group col-md-6">
                                 <label class="form-label" for="lname">Password</label>
                                 <input type="password" class="form-control" id="pass" value="test132">
                              </div>
