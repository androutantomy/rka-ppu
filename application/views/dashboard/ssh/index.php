                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="flex-wrap d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a href="<?php echo site_url('import-ssh') ?>" class="btn btn-link btn-soft-light">
                    ...
                    <div class="table-responsive border rounded">
                        <table id="user-list-table" class="table table-striped" role="grid" data-toggle="data-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a href="<?php echo site_url('edit-ssh') ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                ...
                                <tr>
                                    <td>5.1.0.1</td>
                                    <td>BEBAN PENDIDIKAN DAN PENGAJARAN</td>
                                    <td></td>
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a href="<?php echo site_url('edit-ssh') ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                ...
                                <tr>
                                    <td>5.1.0.1.1.001</td>
                                    <td>Gaji Pokok Karyawan dan Dosen Tetap Yayasan (SMA/D1 - 0-4 Tahun)</td>
                                ...
                                <tr>
                                    <td>5.1.0.1.1.002</td>
                                    <td>Gaji Pokok Karyawan dan Dosen Tetap Yayasan (D2/D3 - 0-4 Tahun)</td>
                                    <td class="text-center">966.000</td>
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a href="<?php echo site_url('edit-ssh') ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                <span class="btn-inner">
                                ...
                                <tr>
                                    <td>5.1.0.1.1.003</td>
                                    <td>Gaji Pokok Karyawan dan Dosen Tetap Yayasan (S1/D4 - 0-4 Tahun)</td>
                                    <td class="text-center">1.127.000</td>
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a href="<?php echo site_url('edit-ssh') ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                <span class="btn-inner">
                                ...
                                <tr>
                                    <td>5.1.0.1.1.004</td>
                                    <td>Gaji Pokok Karyawan dan Dosen Tetap Yayasan (S2 - 0-4 Tahun)</td>
                                    <td class="text-center">1.288.000</td>
                                    <td class="text-center">
                                        <div class="flex align-items-center list-user-action">
                                            <a href="<?php echo site_url('edit-ssh') ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                <span class="btn-inner">
