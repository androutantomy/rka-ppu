            ...
            <div class="sidebar-body pt-0 data-scrollbar">
                <div class="sidebar-list">
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('user') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('tahunAnggaran') ?>">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('pendapatan') ?>">
                                <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('ssh') ?>">
                                <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right">
                                <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('satuan') ?>">
                                <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="<?php echo site_url('kegiatan') ?>">
                                <i class="icon" data-bs-toggle="tooltip" title="Blank Page" data-bs-placement="right">
                                <svg fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
