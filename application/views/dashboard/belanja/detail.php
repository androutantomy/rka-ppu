                    ...
                    <div class="card"  style="padding-top:30px;">
                        <table class="table table-responsive border rounded">
                            <tbody >
                                ...
                                <tr>
                                    ...
                                    <td> : Kegiatan Penyediaan dan Pemeliharaan Sarana & Prasarana</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><strong>Jumlah 2023</strong></td>
                                    <td> : Rp 15.000.000</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="card-body">
                            <div style="float:right;">
                                <a class="btn btn-primary" style="background:#1AA053 !important;color:white;border:1px solid #1AA053 !important;">
