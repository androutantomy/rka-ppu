                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    <a href="<?php echo route('satuan.tambah') ?>" class="btn btn-link btn-soft-light">
                                ...
                                <div class="table-responsive border rounded">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <div class="flex align-items-center list-user-action">
                                                                <a href="<?php echo route('satuan.ubah', ['uuid' => $result->uuid_satuan]) ?>" class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Edit" href="#">
                                                                ...
                                                                <a class="btn btn-sm btn-icon btn-danger rounded btn-delete-user" data-uuid="<?php echo $result->uuid_satuan ?>" data-bs-toggle="modal" data-bs-target="#exampleModalCenter" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Delete">
                                                                    <span class="btn-inner">
                                    ...
                                    <div class="d-flex justify-content-between mb-10 mr-10">
                                        ...
                                        <nav class="d-flex justify-content-end" aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item"><a class="page-link" id="previousPage" href="<?php echo route('satuan.home2', ['offset' => $start != '' && $start > 1 ? $start - 1 : '']) ?>">Sebelumnya</a></li>
                                                <li class="page-item"><a class="page-link" id="currentPage" disabled><?php echo $start != "" ? $start : 1; ?></a></li>
                                                <li class="page-item"><a class="page-link" id="nextPage" href="<?php echo route('satuan.home2', ['offset' => $start != '' && $start < $next ? $start + 1 : '']) ?>">Selanjutnya</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <?php echo form_open(route('satuan.hapus')) ?>
